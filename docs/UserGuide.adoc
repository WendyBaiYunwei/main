...
Make use of `planner_add` command to add one or multiple modules to the degree plan. +
...
order.
** If `tag/TAG` is not supplied in the command as a parameter, modules will be sorted according to credits and
